    ...
    <div className="corsi-scroll" style={{
      ...
      {section('Intelligenza Artificiale', (
        <div style={{ padding: '14px' }}>
          <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.85)', fontWeight: 700, marginBottom: 6 }}>
            Motore AI degli agenti
          </div>
          <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.5)', marginBottom: 12, lineHeight: 1.5 }}>
            Gli agenti AI (scheda, dieta, programmazione corsi) vengono eseguiti server-side tramite Lovable Cloud. Nessuna chiave API è richiesta o memorizzata sul dispositivo.
          </div>
          <div style={{
